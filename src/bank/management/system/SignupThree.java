   ...
   SignupThree(String formno){
     ...
     carddetail.setBounds(100,330,300,20);
      ...
      add( pindetail);
       ...
       c7=new JCheckBox("I HERE BY DECALARES THAT THE ABOVE ENTERED DETAILS ARE CORRECT TO THE BEST OF MY KNOWING");
        ...
        if(r1.isSelected()){
         ...
         String facility="";
          if(c1.isSelected()){
           ...
           facility=facility +"EMAIL ANS SMS ALERTS";
       }
           ...
           if(accountType.equals("")){
               JOptionPane.showMessageDialog(null,"ACCOUNTBTYPE IS REQUIRED");
           }
           else{
                conn conn =new conn();
